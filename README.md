# GeoPacker
GeoPacker is a tool package using a simplified geometric deep learning coupled ResNet for protein side-chain modeling. Particularly, GeoPacker is suitable for large scale protein side chain modeling and overcomes the limitation of rotamer-free protein sequence design due to the admirable efficiency and accuracy.
