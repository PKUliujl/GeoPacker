...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GCNconv(in_channels = 18+7 + 19 +20, out_channels=50, edge_length=175)  # 160
        ...
        self.lin = torch.nn.Linear(50+ 8  ,49*4) #380  +8  +20 
        self.BN = torch.nn.BatchNorm1d(49*4)
        self.drop = torch.nn.Dropout(0.3)

        self.Conv2D1 = torch.nn.Sequential(
                torch.nn.Conv2d(in_channels = 1 + 2*2, out_channels = 8, kernel_size=3, padding=1),
